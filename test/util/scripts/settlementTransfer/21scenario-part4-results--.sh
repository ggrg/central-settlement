...
echo "TODO => EXPECTED RESULT: Both settlement accounts are now PS_TRANSFERS_COMMITTED. Showing 8 records (previously 6)."
echo
echo
...
echo "TODO => EXPECTED RESULT: Settlement state has changed also to PS_TRANSFERS_COMMITTED. Showing 4 records (previously 3)."
echo ""
echo
echo
...
echo "TODO => EXPECTED RESULT: Both settlement transfers are now fulfiled. Showing 4 records (previously 2)."
echo
echo
...
echo "TODO => EXPECTED RESULT: 2 records have been inserted - both settlement transfers are COMMITTED. Showing total 14 records (previously 12)."
...
ON p.participantId = pc.participantId
ORDER BY 1 DESC"
echo "TODO => EXPECTED RESULT: NET_SETTLEMENT_SENDER's position has been adjusted for the settlement transfer commit."
...
ORDER BY 1 DESC"
echo "TODO => EXPECTED RESULT: Showing history for the participantPosition bottom-up. Now showing 8 records (prevously 6)."
echo
echo
