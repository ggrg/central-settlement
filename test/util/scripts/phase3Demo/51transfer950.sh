...
echo "---------------------------------------------------------------------"
echo "Prepare a transfer (dfsp1 -> dfsp2: 950 USD)"
echo "---------------------------------------------------------------------"
...
sh -c "curl -X POST \
  ...
  -d '{
    \"transferId\": \"888ec534-ee48-4575-b6a9-ead2955b8201\",
    \"payerFsp\": \"dfsp1\",
    \"payeeFsp\": \"dfsp2\",
    \"amount\": {
      \"currency\": \"USD\",
...
sh -c "curl -X PUT \
  http://127.0.0.1:3000/transfers/888ec534-ee48-4575-b6a9-ead2955b8201 \
