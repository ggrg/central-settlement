...
echo "=> EXPECTED RESULT: Settlement state has changed also to PS_TRANSFERS_RESERVED. Showing 3 records."
echo
echo
...
ORDER BY 1 DESC"
echo "=> EXPECTED RESULT: Debits for SETTLEMENT_NET_RECIPIENT accounts have been applied during PS_TRANSFERS_RESERVED."
echo
echo
